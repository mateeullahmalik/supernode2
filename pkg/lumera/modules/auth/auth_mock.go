...
func (mr *MockModuleMockRecorder) AccountInfoByAddress(ctx, addr interface{}) *gomock.Call {
...
func (mr *MockModuleMockRecorder) Verify(ctx, accAddress, data, signature interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
